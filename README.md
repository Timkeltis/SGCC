...
数据来自国网接口，需配合代理工具的 **Home Assistant 重写**（由代理层现场登录国网并返回数据）。支持 Surge、Loon、Quantumult X 等 iOS 代理工具。
...
数据来自国家电网接口（经 Home Assistant 重写代理），由代理层公开接口提供，本仓库仅做展示，不保存任何账号密码。
数据仅作参考，请以国网 App 为准。
