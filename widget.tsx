...
async function main() {
  ...
  // 优先读取本地 Logo，避免每次小组件刷新额外访问 GitHub。
  let logoImage: UIImage | null = null
  try {
    logoImage = UIImage.fromFile(Path.join(FileManager.appGroupDocumentsDirectory, 'sgcc_logo_cache.png'))
  } catch (e) {
    console.log(`本地国网 logo 加载失败：${e instanceof Error ? e.message : e}`)
  }
